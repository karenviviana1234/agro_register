...
export const validacionCostosR = [
    ...
    check('fk_id_actividad').notEmpty().withMessage('La fk es obligatoria').isNumeric().withMessage('La fk  debe ser un número'),
...
export const validacionCostosA = [
    ...
    check('fk_id_actividad').optional().isNumeric().withMessage('La fk debe ser un número'),
